                                        ...
                                        <div class="row">
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img"
                                                        src="assets/img/voiture.png" alt="Brand Logo">
                                                </a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="{{ route('montre') }}"><img class="img-fluid brand-img"
                                                        src="assets/img/chaussure.png" alt="Brand Logo">
                                                </a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img"
                                                        src="assets/img/montre.png" alt="Brand Logo">
                                                </a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img"
                                                        src="assets/img/sac.png" alt="Brand Logo">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                ...
                @foreach ($products as $product)
                    <div class="col mb-5">
                        <div class="card h-100">
                            <a href="{{ route('products.info', ['id'=>$product->id]) }}">
                            ...
                            <div class="card-body ">
                                ...
                                {{-- <button type="submit" href="{{ route('products.show', $product->id) }}"
